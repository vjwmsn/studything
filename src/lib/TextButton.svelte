...
<style>
    .regular-button {
        border: 0;
        border-radius: 10px;
        background: linear-gradient(hsl(257, 90%, 50%),hsl(257, 90%, 35%));
        padding: 10px;
        color: hsl(0, 0%, 95%);
        opacity: 100%;
        transition: 0.3s;
    ...
    .regular-button:hover {filter: drop-shadow(0 0 0.25rem hsl(257, 100%, 50%)) brightness(120%); cursor: pointer; background: linear-gradient(hsl(257, 90%, 50%),hsl(257, 90%, 35%)); border-radius: 15px;}
