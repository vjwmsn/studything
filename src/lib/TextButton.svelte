...
<style>
    ...
    .regular-button:hover {filter: drop-shadow(0 0 0.25rem hsl(257, 100%, 50%)); cursor: pointer; background: linear-gradient(hsl(257, 90%, 50%),hsl(257, 90%, 35%)); border-radius: 15px;}
